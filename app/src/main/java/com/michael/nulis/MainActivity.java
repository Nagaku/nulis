...
import com.michael.nulis.model.AppDatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static void hide_button() {
        if ((MainActivity.getButton_tambah().getVisibility() == View.VISIBLE) )
            MainActivity.getButton_tambah().setVisibility(View.INVISIBLE);
        else if (current_page != page.PROFILE && current_page != page.EXPLORE) {
            MainActivity.getButton_tambah().setVisibility(View.VISIBLE);
            MainActivity.getFragmentHandler().clean();
        }
    ...
    public static void hide_all() {
        ...
        MainActivity.getButton_ok().setVisibility(View.GONE);
        MainActivity.getButton_no().setVisibility(View.GONE);
